    ...
    <div class="detail_news">
        ...
        <div class="detail_news_info">
            ...
            <div class="detail_news_info_image">
                <img src="/bitrix/templates/11/images/<?= htmlspecialchars($arResult['detailNews']['image']) ?>">
            </div>
        </div>
        <a href="/news-list/page-1/" class="detail_news_back_page">
            <img class="arrow_back_page" src="/bitrix/templates/11/icons/arrow-back-page.png">
            назад к новостям
        </a>
    </div>
</div>