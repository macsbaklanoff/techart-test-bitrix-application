...
document.addEventListener('DOMContentLoaded', function () {
  ...
  async function initMap() {
    ...
    const {
      YMapDefaultMarker
    } = await window.ymaps3.import('@yandex/ymaps3-markers@0.0.1');
    // const {YMapDefaultMarker} = await import('@yandex/ymaps3-default-ui-theme');
    ...
    const myPlacemark = new YMapDefaultMarker({
      ...
      onClick: event => {
        ...
        popup.style.top = relativeY + 'px';
        popup.style.left = relativeX + 'px';
        if (popup.style.display == 'none') popup.style.display = 'flex';else popup.style.display = 'none';
      }
    });
    map.addChild(myPlacemark);
  }
...
/******/ })()
;
//# sourceMappingURL=index.1758888346563.js.map