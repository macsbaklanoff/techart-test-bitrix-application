    ...
    <div class="product-item-container" data-entity="item">
        <div class="product-item">
            <a class="product-item-image-wrapper" href="/books/?SECTION_ID=&amp;ELEMENT_ID=106"
                ...
                <span class="product-item-image-slider-slide-container slide" id="{{ $areaId . '_pict_slider'}}"
                    style="display: none;" data-slider-interval="3000" data-slider-wrap="true">
                </span>
                <span class="product-item-image-original" id="{{ $areaId . '_pict'}}"
                    style="background-image: url('{{ $item['DETAIL_PICTURE']['SRC'] }}'); ">
                </span>
                <span class="product-item-image-alternative"
                    id="{{ $areaId . '_secondpict'}}"
                    style="background-image: url('{{ $item['DETAIL_PICTURE']['SRC'] }}'); ">
                </span>
                <div class="product-item-image-slider-control-container" id="{{ $areaId . '_pict_slider_indicator'}}"
                    style="display: none;">
                </div>
            </a>
            ...
            <div class="product-item-info-container product-item-price-container" data-entity="price-block">
                <span class="product-item-price-current" id="{{ $areaId . '_price'}}">
